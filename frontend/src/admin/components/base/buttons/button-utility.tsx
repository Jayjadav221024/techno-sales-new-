...
export const styles = {
    ...
    // Destructive row actions need to read as dangerous on hover without
    // shouting in the resting state - a table of red icons is unreadable.
    "tertiary-destructive": "text-fg-quaternary hover:bg-error-primary hover:text-fg-error-primary",
};
