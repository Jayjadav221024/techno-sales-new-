...
export default function ThreeHeroCanvas({ category = 'motors' }) {
  ...
  useEffect(() => {
    ...
    meshGroup.position.set(4.2, 0, 0);
    scene.add(meshGroup);
    meshGroupRef.current = meshGroup;

    // Holographic Polar Grid
    const gridHelper = new THREE.PolarGridHelper(3.8, 16, 8, 64, 0x00e5ff, 0x002233);
    gridHelper.position.set(4.2, -3.2, 0);
    ...
    scanningRing.position.set(4.2, 0, 0);
