 ...
 */
router.post("/countries", authMiddleware(ANY_ROLE), createCountry);
 ...
 *         description: Unauthorized
 */
router.post("/states", authMiddleware(ANY_ROLE), createState);
 ...
 *         description: Unauthorized
 */
router.post("/cities", authMiddleware(ANY_ROLE), createCity);
